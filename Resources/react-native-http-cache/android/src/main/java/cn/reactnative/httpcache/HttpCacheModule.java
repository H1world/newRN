...
public class HttpCacheModule extends ReactContextBaseJavaModule {
    ...
    public void getImageCacheSize(Promise promise){
        FileCache cache1 = ImagePipelineFactory.getInstance().getMainFileCache();//.getMainDiskStorageCache();
        ...
        FileCache cache2 = ImagePipelineFactory.getInstance().getSmallImageFileCache();//.getSmallImageDiskStorageCache();
